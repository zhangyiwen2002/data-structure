...
public:
    ...
    void setupUi(QDialog *expenseShow)
    {
        ...
        expenseShow->resize(400, 300);
        widget = new QWidget(expenseShow);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(10, 10, 371, 41));
        ...
        widget_2->setGeometry(QRect(10, 60, 371, 41));
        ...
        widget_3->setGeometry(QRect(10, 110, 371, 41));
        ...
        widget_4->setGeometry(QRect(10, 160, 371, 41));
        ...
        widget_5->setGeometry(QRect(10, 210, 371, 41));
